...
export const atlasViewLinks: AtlasViewLink[] = [
  ...
  { area: 'Panel operaciones', phase: 'CRM B2B', title: 'Pipeline comercial (oportunidades, tablero y aprobaciones)', href: '/operaciones/crm/oportunidades', status: 'solo-accion', backend: 'POST/PATCH /b2b/opportunities' },
