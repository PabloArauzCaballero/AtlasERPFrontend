...
export const atlasViewLinks: AtlasViewLink[] = [
  ...
  { area: 'Panel operaciones', phase: 'CRM B2B', title: 'Excepciones comerciales', href: '/operaciones/crm/aprobaciones', status: 'solo-accion', backend: 'PATCH /b2b/proposals/approvals/:id/decision' },
  ...
  { area: 'Panel operaciones', phase: 'Contabilidad', title: 'Estructura financiera', href: '/operaciones/contabilidad/estructura', status: 'solo-accion', backend: 'POST /accounting/financial-structure/* (entidades, dimensiones, bancos, ejercicios, períodos y libros)' },
