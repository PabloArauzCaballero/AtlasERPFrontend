...
export default function B2BBillingPage() {
  ...
  return <MultiActionWorkspace moduleLabel="CRM" title="New B2B Invoice" description="Emita facturas por MDR u otros conceptos y registre pagos con aplicación explícita a cuentas por cobrar." actions={[
