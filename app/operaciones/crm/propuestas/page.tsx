 ...
 *
 * Sin pestañas: «Nueva propuesta» y «Rechazar» eran verbos metidos en la barra de secciones. El alta
 * lleva líneas y columna lateral, así que va a su propia página (`/crear`); rechazar va en la fila.
 *
 * Y pantalla propia, no pestaña del pipeline. Estuvo un rato metida ahí dentro con el argumento de
 * que una propuesta es el paso siguiente de una oportunidad; no se queda, por decisión de producto:
 * la cartera de propuestas se consulta y se trabaja por sí sola —qué se ofreció, a quién, por
 * cuánto y hasta cuándo—, y esconderla detrás del embudo obligaba a entrar al pipeline para algo
 * que no es mover una oportunidad de etapa. Su entrada va la ÚLTIMA del grupo CRM en el menú.
 */
