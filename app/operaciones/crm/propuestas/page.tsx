...
/**
 * Las propuestas son una pestaña del pipeline, no una pantalla aparte.
 *
 ...
 * usan el menú, el panel de inicio, las guías por ruta y los recorridos guiados— y abre la misma
 * pantalla con la pestaña «Propuestas» delante.
 */
