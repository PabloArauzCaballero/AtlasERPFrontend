      ...
      rowActions={(row) => [
        {
          ...
          form: {
            ...
            fields: [
              { name: 'status', label: 'Estado', tooltip: 'Estado del anunciante: sólo uno activo puede lanzar campañas y consumir crédito.', required: true, optionsSource: 'domain:ads.advertiserStatus' },
              { name: 'riskStatus', label: 'Riesgo', tooltip: 'Nivel de riesgo del anunciante según cobros y moderación; uno bloqueado no entrega anuncios.', optional: true, optionsSource: 'domain:ads.riskStatus' },
              { name: 'reason', label: 'Motivo', tooltip: 'Por qué cambia el riesgo del anunciante; queda registrado para auditoría.', required: true, span: 3, placeholder: 'Documentación fiscal verificada' },
            ],
