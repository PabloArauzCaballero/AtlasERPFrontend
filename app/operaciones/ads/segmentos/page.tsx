 ...
 *
 * El alta es el modal del botón «Nuevo segmento», no una pestaña: el botón de la tabla no cambia
 * de sitio para pedir lo que ya se estaba mirando.
 */
export default function AdSegmentsPage() {
  /* La tabla se recarga sola tras el alta: el modal vive dentro de ella. */
  const createSegment = useCallback(async (payload: JsonObject) => {
