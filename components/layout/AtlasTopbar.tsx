  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-50 flex h-16 items-center justify-between border-b border-slate-200 bg-white px-4 md:px-6">
      <div className="flex min-w-0 items-center gap-6">
        <Link href="/operaciones" className="shrink-0 text-lg font-black tracking-tight text-[#031636]">ATLAS ERP</Link>
        <form onSubmit={submit} className="hidden h-9 w-72 items-center gap-2 rounded-md border border-slate-200 bg-slate-50 px-3 focus-within:border-[#031636] focus-within:bg-white md:flex">
      ...
      <div className="flex items-center gap-1.5">
        <Link href="/operaciones/contabilidad/documentos" className="mr-2 hidden h-9 items-center gap-2 rounded-md bg-[#031636] px-3 text-xs font-bold text-white shadow-sm hover:bg-[#142746] sm:flex">
        ...
        <div className="relative ml-1">
          <button
            ...
            className="grid h-8 w-8 place-items-center rounded-full bg-[#1a2b4c] text-[10px] font-black text-white ring-2 ring-slate-100"
