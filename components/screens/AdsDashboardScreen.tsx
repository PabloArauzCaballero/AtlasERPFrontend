...
export function AdsDashboardScreen() {
  ...
  return (
    <div className="space-y-5">
      <WorkspaceHeader breadcrumbs={[{ label: 'Ads' }, { label: 'Dashboard' }]} title="Campaign Management" description="Monitoree facturación, delivery, moderación y señales de fraude con datos del backend Ads." actions={<><AtlasButton variant="secondary" icon="calendar_today">Últimos 30 días</AtlasButton><AtlasButton variant="secondary" icon="refresh" onClick={reload}>Actualizar</AtlasButton></>} />
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1.5fr)_360px]">
        <Panel title="Billing & Delivery Health" description="Indicadores de control operativo obtenidos de GET /admin/ads/dashboard." icon="monitoring">
