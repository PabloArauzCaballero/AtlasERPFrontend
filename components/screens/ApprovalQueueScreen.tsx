    ...
    <div className="space-y-5">
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1.4fr)_360px]">
        <Panel title="Exception Requests" icon="request_quote">
          <div className="rounded-md border border-dashed border-slate-300 bg-slate-50 px-6 py-16 text-center"><Icon name="inbox" className="text-[42px] text-slate-400" /><p className="mt-3 text-sm font-bold text-slate-700">No existe endpoint para listar aprobaciones</p><p className="mx-auto mt-1 max-w-xl text-xs leading-5 text-slate-500">Cuando el backend exponga la consulta, este panel mostrará solicitante, propuesta, MDR solicitado, umbral, impacto de margen, antigüedad y responsable.</p></div>
        </Panel>
