...
interface ApprovalsDirectoryProps {
  /** Dentro de una pestaña del pipeline: sin cabecera propia de pantalla. */
 ...
 *
 * Vive dentro del pipeline y es su ÚLTIMA pestaña porque es el último paso del mismo trato: una
 * excepción de MDR se pide desde una propuesta y bloquea su cierre hasta que alguien la decide.
 * Como entrada suelta del menú obligaba a salir del embudo para responder algo que sólo tiene
 * sentido mirando la propuesta que lo pidió.
 */
export function ApprovalsDirectory({ embedded = false }: ApprovalsDirectoryProps = {}) {
