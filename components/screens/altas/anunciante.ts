...
/**
 * Los campos del alta de un anunciante, en un módulo aparte.
 *
 * Los usan DOS sitios: el formulario de `/operaciones/ads/anunciantes/crear` y la carga masiva del
 * listado de anunciantes. Estaban escritos dentro de la página de alta, así que el listado no
 * podía ofrecer «Importar»: no tenía de dónde sacar la plantilla. Definidos una vez, la plantilla
 * del Excel no puede quedarse desfasada respecto del formulario.
 */
export const seccionesAltaAnunciante: FormSectionDefinition[] = [
  {
    title: 'Identidad del anunciante',
    icon: 'business',
    fields: [
      ...
      { name: 'tradeName', label: 'Nombre comercial', tooltip: 'Nombre con el que el negocio se presenta al público, si es distinto del legal. Ej.: «Tienda Doña Rosa».', required: true },
      /*
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'primaryContactEmail', label: 'Correo', tooltip: 'Correo del contacto principal; ahí llegan las notificaciones de campaña y facturación.', type: 'email', optional: true },
      ...
      { name: 'creditLimitMicros', label: 'Límite de crédito (micros)', tooltip: 'Crédito máximo en micros que puede consumir antes de pagar. Ej.: 1000000000 = Bs 1 000.', type: 'number', valueKind: 'number', defaultValue: 0 },
    ],
  },
];

export const avisoAltaAnunciante = 'El límite se expresa en micros. BOB 1,00 equivale a 1.000.000 micros.';
