          ...
          {activities.map((activity) => {
            ...
            return (
              <li key={String(activity.id)} className="flex gap-3">
                <span className="mt-0.5 grid h-8 w-8 shrink-0 place-items-center rounded-full bg-blue-50 text-[#031636]"><Icon name={typeIcon[type] ?? 'bolt'} className="text-[16px]" /></span>
