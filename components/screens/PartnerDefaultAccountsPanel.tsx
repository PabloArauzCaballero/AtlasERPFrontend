        ...
        {allPurposes.map((purpose) => {
          ...
          return (
            <div key={purpose} className="flex flex-col gap-2 rounded-md border border-slate-200 p-2 sm:flex-row sm:items-center">
              ...
              <input
                className="h-9 flex-1 rounded-md border border-slate-300 bg-white px-3 font-mono text-[11px] outline-none focus:border-[#031636] focus:ring-2 focus:ring-blue-100"
