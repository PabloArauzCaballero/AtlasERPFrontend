 ...
 *
 * Vive como componente, y no como página, porque el mismo listado se enseña en la pestaña
 * «Propuestas» del pipeline: una propuesta es el paso siguiente de una oportunidad y se consulta
 * junto a ella, no en otra pantalla a la que haya que navegar por el menú lateral.
 */
