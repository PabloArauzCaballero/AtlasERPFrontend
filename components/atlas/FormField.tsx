...
const controlClass = 'h-9 w-full rounded-md border border-slate-300 bg-white px-3 text-sm text-slate-900 outline-none placeholder:text-slate-400 focus:border-[#031636] focus:ring-2 focus:ring-blue-100 disabled:bg-slate-100';
